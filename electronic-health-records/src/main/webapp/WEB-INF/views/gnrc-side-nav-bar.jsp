...
<div class="col-md-2 col-sm-1 hidden-xs display-table-cell valign-top side-active"
	id="side-menu">
	<h1 class="hidden-xs hidden-sm"><a id="menu-toggle" href="patient.portal"><span id="main_icon" class="glyphicon glyphicon-align-justify" aria-hidden="true"></span>GNRC</a></h1>
	<ul>
		<li class="link active"><a href="patient.list"> <span
		...
		<li class="link"><a href="#collapse-registration"
			...
			<ul class="collapse collapseable" id="collapse-registration">
				<li><a href="#">Patient Identification Card </a></li>
				<li><a href="#">Investigation Sheet </a></li>
				<li><a href="#">Doctor's Notes </a></li>
				<li><a href="#">Doctor's Orders </a></li>
				<li><a href="#">Consultation Record</a></li>
				<li><a href="#">Laboratory Report</a></li>
				<li><a href="#">Transfer Summary </a></li>
