...
public class InvestigationSheetServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			if ("GET_PREV_INVEST_RECORD".equals(action)) {
				System.out.println("In GET_PREV_INVEST_RECORD part");
				...
				List<String> list1 = patientDao.getPreviousRecordNo(ipNo, paramType);
				System.out.println("LIST VALUE " + list1);
				out.println(list1);
			} else if ("FETCH_PARAM_NAME".equals(action.trim())) {
				...
				System.out.println("Row name : " + row);
				...
				/*
				 * out.
				 * println("<table id=\"fixedColumnExample\" class=\"table table-striped table-bordered nowrap\" style=\"width:100%\">"
				 * ); out.println("<thead>"); out.println("<tr>");
				 * out.println("<th>Parameter</th>"); for (int i = 0; i < row.size(); i +=
				 * col.size()) { out.println("<th>" + row.get(i) + "</th>"); }
				 * out.println("</tr>"); out.println("</thead>"); out.println("<tbody>"); //
				 ...
				 * //System.out.println("Count : " + count++); out.println("<td>" + row.get(i +
				 * index) + "</td>"); }
				 * 
				 * out.println("</tr>"); index++; //j++; }
				 * 
				 * 
				 * out.println("</tbody>");
				 * 
				...
				out.println(
						"<table id=\"fixedColumnExample\" class=\"table table-striped table-bordered nowrap\" style=\"width:100%\">\r\n"
								+ "        <thead>\r\n" + "            <tr>\r\n"
								+ "                <th>First name</th>\r\n" + "                <th>Last name</th>\r\n"
								+ "                <th>Position</th>\r\n" + "                <th>Office</th>\r\n"
								+ "                <th>Age</th>\r\n" + "                <th>Start date</th>\r\n"
